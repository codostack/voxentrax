...
const VoipEnterpriseHero = () => {
  ...
  const quadrants = [
    ...
    {
      id: "bottom-left",
      position: "bottom-11 left-1 -translate-x-10",
    ...
    {
      id: "bottom-right",
      position: "bottom-11 right-1 translate-x-10",
      color: "bg-orange-600",
      title: "Auto Scaling",
  ...
  return (
    <div className="bg-white text-slate-900 font-sans overflow-hidden flex items-center justify-center p-6">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="z-10 space-y-8 text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          <p
            className="font-['DM_Sans',sans-serif] text-gray-500 text-sm md:text-[16px] leading-7 tracking-normal
              text-justify max-w-[600px] [@media(min-width:1300px)]:max-w-[560px]"
          >
            Build a carrier-grade VoIP infrastructure designed for high-volume
            call centers and wholesale voice operations. Optimize call routing
            with intelligent LCR, ensure low-latency connectivity across global
            routes, and maintain superior call quality with real-time monitoring
            and failover systems. Scalable, secure, and engineered to handle
            millions of minutes without compromise.
          </p>
        ...
        {/* RIGHT SIDE: THE EXPANDED ORBIT SYSTEM — hidden on mobile/tablet */}
        <div className="relative hidden lg:flex items-center justify-center h-[690px] w-full">
